...
export default function RelatedProducts({
  ...
  useEffect(() => {
    const fetchRelatedProducts = async () => {
      ...
      try {
        const query = `fields[0]=name&fields[1]=slug&populate[categories][fields][0]=name&populate[model][fields][0]=name&populate[brand][fields][0]=name&populate[images][fields][0]=url&populate[images][fields][1]=alternativeText&pagination[pageSize]=1000&sort[0]=createdAt:desc`
